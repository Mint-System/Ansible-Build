<img src="/logos/pushgateway.png" alt="pushgateway logo" width="100" height="100">
...
pushgateway_basic_auth_username: metric # default: pushgateway
pushgateway_basic_auth_password: # default: "{{ vault_pushgateway_basic_auth_password }}"
```
